...
function setTypeBackgroundColor(pokemon) {
  ...
  setElementStyles(
    [document.querySelector(".power-wrapper > p")],
    "backgroundColor",
    color
  );
  setElementStyles(
    [document.querySelector(".stats-wrap p.stats")],
    "color",
    color
  );
  setElementStyles(
    [document.querySelector(".stats-wrap .progress-bar")],
    "color",
    color
  );
